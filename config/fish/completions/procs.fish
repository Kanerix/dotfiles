...
complete -c procs -l sorta -d 'Sort column by ascending' -r -f -a "command\t'Command with all arguments'
...
complete -c procs -l sortd -d 'Sort column by descending' -r -f -a "command\t'Command with all arguments'
contextsw\t'Context switch count'
cputime\t'Cumulative CPU time'
docker\t'Docker container name'
elapsedtime\t'Elapsed time'
...
vmtotal\t'Total footprint size'
writebytes\t'Write bytes to storage'"
complete -c procs -s i -l insert -d 'Insert column to slot' -r -f -a "command\t'Command with all arguments'
contextsw\t'Context switch count'
cputime\t'Cumulative CPU time'
docker\t'Docker container name'
elapsedtime\t'Elapsed time'
...
vmtotal\t'Total footprint size'
writebytes\t'Write bytes to storage'"
complete -c procs -l only -d 'Specified column only' -r -f -a "command\t'Command with all arguments'
contextsw\t'Context switch count'
cputime\t'Cumulative CPU time'
docker\t'Docker container name'
elapsedtime\t'Elapsed time'
